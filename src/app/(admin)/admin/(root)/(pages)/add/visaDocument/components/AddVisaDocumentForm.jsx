...
export default function AddVisaDocumentForm() {
  ...
  async function addNewVisaDocument() {
    ...
    if (documentName && documentDescription) {
      ...
      // Check if documentDescription object has 3 keys: description_en, description_fr, description_ar
        ...
        try {
          ...
          const response = await fetch(`${documents_api}/addVisaDocument`, {
            method: 'POST',
            headers: {
          ...
          if (result.err) {
            ...
            createToast({ msg: `The visa document added successfully`, status: 'success' })
          }
  ...
  return (
    <div className="flex flex-col gap-[50px]">
      ...
      <HtmlActionHandlerButton
        text="Add new visa document"
        icon={<AddNewFileIcon />}
        onClick={addNewVisaDocument}
