...
import NoDocumentsToDisplay from "./NoDocumentsToDisplay";
import { Badge } from "@tremor/react";




export default function UpdateUniversityDocumentForm() {
  ...
  useEffect(() => {
    ...
    async function getDocuments() {
      ...
      try {
        ...
        const { data: response } = await axios.get(`${documents_api}/getUniversityDocuments`)
