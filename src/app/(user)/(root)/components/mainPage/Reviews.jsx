...
import { StartUpIcon, SupportIcon } from "@/constants/Icons";
...
export default function Reviews({
    ...
    return (
        <div className="mt-5 flex flex-col gap-2 w-full x-white-space">

            <p className="section-title text-center">What our customers says</p>
